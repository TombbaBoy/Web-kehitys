...
// Assuming Leaflet library is included in your HTML

// Initialize map centered on Finland
const map = L.map('map').setView([61.9241, 25.7482], 6);
...
restaurants.forEach(restaurant => {
  const [lng, lat] = restaurant.location.coordinates; // coordinates are [lng, lat]
